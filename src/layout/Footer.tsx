...
const Footer = () => {
  return (
    <MainContainer>
      <footer className="px-3 py-8 bg-gray-800 text-2 text-gray-200 transition-colors duration-200">
        <div className="flex flex-col">
          ...
          <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
            <nav className="flex-1 flex flex-col items-center justify-center md:items-end md:border-r border-gray-100 md:pr-5">
              <Link href="/hardware">
                <div className="hover:text-white cursor-pointer">Matériel</div>
              </Link>
              <Link href="/software">
                <div className="hover:text-white cursor-pointer">Logiciel</div>
              </Link>
              <Link href="/help">
            ...
            <div className="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
              <a
                ...
                href="https://github.com/PierreG-dev/Depannage.Pierre-godino.com"
              >
                ...
                <svg
                  ...
                  height="30"
                  fill="currentColor"
                  className="text-xl opacity-70 hover:opacity-100 transition-colors"
              ...
              <Link href="/">
                <div className="ml-4 hover:text-primary-gray-20 cursor-pointer">
